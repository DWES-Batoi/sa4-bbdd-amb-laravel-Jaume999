    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="flex space-x-2 border-r border-gray-200 dark:border-gray-700 pe-4 me-2">
                    <a href="{{ route('lang.switch', 'ca') }}" class="text-xs font-bold px-1 {{ app()->getLocale() == 'ca' ? 'text-blue-600 underline' : 'text-gray-500 hover:text-gray-700' }}">CA</a>
                    <a href="{{ route('lang.switch', 'es') }}" class="text-xs font-bold px-1 {{ app()->getLocale() == 'es' ? 'text-blue-600 underline' : 'text-gray-500 hover:text-gray-700' }}">ES</a>
                    <a href="{{ route('lang.switch', 'en') }}" class="text-xs font-bold px-1 {{ app()->getLocale() == 'en' ? 'text-blue-600 underline' : 'text-gray-500 hover:text-gray-700' }}">EN</a>
                </div>
